<script lang="ts">
	...
	// addlink form sometimes gets prepopulated with old data
	...
	// create a confirmation component for deleting anything
	// rn it's too easy to delete something by accident 
